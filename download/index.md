# 下载程序
当您无法通过搜索引擎寻找到正确的安装地址时，您可以通过本页提供的链接获取最新版本的程序。

::: warning 服务须知
在您点击下载按钮后，默认您已经同意我们的[《服务条款》](https://docs.vilinko.com/agreement/tos.html)和[《隐私政策》](https://docs.vilinko.com/agreement/privacy.html)。
:::

::: tip 安装提示
不可下载的程序可能处于开发或邀测状态，感谢您的理解。
:::
...
- [Windows X64](https://down1.vilinko.com/download/lightframe.zip)
- [Windows X86](https://down1.vilinko.com/download/lightframe_x86.zip)
...
## Vui.parser
- [点击打开网页版](https://haceau-zoac.github.io/vui.parser/)
